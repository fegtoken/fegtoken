...
contract FToken is ReentrancyGuard, FTokenBase {
    ...
    string  private _symbol   = "FEGfGOLD";
...
contract FEGexV2 is FSilver, ReentrancyGuard, FToken, FMath {
    ...
    address private _poolOwner = 0x27318b9165b0713A2342cC109dDabDEe86B32840;
    address public Wrap = 0x6E5eAF71E9958d9cf3f51F46a94A77fb2b5fCA70;
    address public GOLD = 0xd0f653aD03ca32A792AbFA6d6711cdf1311e5d9D;
    address public Token = 0xacFC95585D80Ab62f67A14C566C1b7a49Fe91167;
    address public pairRewardPool = 0x27318b9165b0713A2342cC109dDabDEe86B32840;
    ...
    function setupWrap() public {
        IERC20(address(GOLD)).approve(address(Wrap), 100000000000000000e18);        
    }  
        ...
        returns (uint tokenAmountOut, uint spotPriceAfter)
    {
        ...
        require(tokenAmountOut >= minAmountOut, "ERR_LIMIT_OUT");
        require(spotPriceBefore <= bdiv(tokenAmountIn, tokenAmountOut), "ERR_MATH_APPROX");
        _pullUnderlying(GOLD, msg.sender, tokenAmountIn);
        ...
        returns (uint tokenAmountOut, uint spotPriceAfter)
    {
        ...
        _pushUnderlying(GOLD, too, (out1 * 99/100));
